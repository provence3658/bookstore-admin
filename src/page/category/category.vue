<template>
  <div class="category">
    <h1>品类管理</h1>
    <el-button type="primary" class="add-btn" @click="addCategoryBtn()" round>添加品类</el-button>
    <el-table
      :data="data"
      stripe
      style="width: 100%">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-show="scope.row.parentId === 0" @click="getChildren(scope.row)" type="text" size="small">查看子品类</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
...
export default {
  ...
  methods: {
    getCategoryList(categoryId) {
      var _this = this
      _category.getCategoryList(categoryId,res=>{
        _this.data = res
        // console.log(res)
      },err=>{
