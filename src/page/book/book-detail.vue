  ...
  <div class="book-detail">
    ...
    <el-form ref="form" :model="bookInfo" label-width="80px">
      <el-form-item label="书籍名称">
        <el-input v-model="bookInfo.name" disabled></el-input>
      </el-form-item>
      ...
      <el-form-item label="内容简介">
        <el-input type="textarea" rows="10" v-model="bookInfo.description"></el-input>
      </el-form-item>
      <el-form-item>
